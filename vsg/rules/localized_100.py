...
lTokens.append(
    [
        token.constant_declaration.subtype_indication,
...
class rule_100(Rule):
    ...
    def __init__(self):
        Rule.__init__(self, "localized", "100", lTokens[0][0], lTokens[0][1])
...
class rule_101(Rule):
    ...
    def __init__(self):
        Rule.__init__(self, "localized", "101", lTokens[1][0], lTokens[1][1])
        self.solution = "Ensure 1 space between target and <="
...
class rule_102(Rule):
    ...
    def __init__(self):
        Rule.__init__(self, "localized", "102", lTokens[2][0], lTokens[2][1])
        self.solution = "Ensure 1 space between target and <="
...
class rule_103(Rule):
    ...
    def __init__(self):
        Rule.__init__(self, "localized", "103", lTokens[3][0], lTokens[3][1])
        self.solution = "Ensure 1 space between target and <="
...
class rule_104(Rule):
    ...
    def __init__(self):
        Rule.__init__(self, "localized", "104", lTokens[4][0], lTokens[4][1])
        self.solution = "Ensure 1 space between target and <="
...
class rule_105(Rule):
    ...
    def __init__(self):
        Rule.__init__(self, "localized", "105", lTokens[5][0], lTokens[5][1])
        self.solution = "Ensure 1 space between target and <="
...
class rule_106(Rule):
    ...
    def __init__(self):
        Rule.__init__(self, "localized", "106", lTokens[6][0], lTokens[6][1])
        self.solution = "Ensure 1 space between target and <="
...
class rule_107(Rule):
    ...
    def __init__(self):
        Rule.__init__(self, "localized", "107", lTokens[7][0], lTokens[7][1])
        self.solution = "Ensure 1 space between target and <="
...
class rule_108(Rule):
    ...
    def __init__(self):
        Rule.__init__(self, "localized", "108", lTokens[8][0], lTokens[8][1])
        self.solution = "Ensure 1 space between target and <="
